                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="tp-slider-3__content text-center home-hero__content">
                                            ...
                                            <p class="home-hero__lede">Empowering young mothers and families in Uganda through skills, enterprise, and Christ-centered care.</p>
                                            <div class="home-hero__actions d-flex flex-wrap justify-content-center gap-2 gap-md-3 pt-10">
                                                ...
                                                <a class="tp-btn home-hero__btn home-hero__btn--outline" href="{{ route('sponsorship.hub') }}">Sponsorship</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
